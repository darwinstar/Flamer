...
import com.example.gyde.desktop.lib.R;
...
public class EditProfileNew extends Activity implements OnClickListener {
	...
	private void initData() {
		...
		firstImage = (ImageView) findViewById(com.example.gyde.desktop.lib.R.id.userprofilpicture);
		secondImage = (ImageView) findViewById(com.example.gyde.desktop.lib.R.id.firtstImage);
		thirdImage = (ImageView) findViewById(com.example.gyde.desktop.lib.R.id.secondImage);
		fourthImage = (ImageView) findViewById(com.example.gyde.desktop.lib.R.id.thirdimageview);
		fifthImage = (ImageView) findViewById(com.example.gyde.desktop.lib.R.id.fourtthimageview);
		sixImage = (ImageView) findViewById(com.example.gyde.desktop.lib.R.id.fifthImageview);
		editprofileTextivew = (TextView) findViewById(com.example.gyde.desktop.lib.R.id.editprofileTextivew);
		edtStatus = (EditText) findViewById(com.example.gyde.desktop.lib.R.id.edtStatusS);
		deleteLayout = (LinearLayout) findViewById(com.example.gyde.desktop.lib.R.id.deleteandeditbuttonlayout);
		btnEdit = (Button) findViewById(com.example.gyde.desktop.lib.R.id.editbuton);
		btnDelete = (Button) findViewById(com.example.gyde.desktop.lib.R.id.deletebutton);
		btnSetProfile = (Button) findViewById(com.example.gyde.desktop.lib.R.id.setProfileButton);
		btnSubmit = (Button) findViewById(com.example.gyde.desktop.lib.R.id.btnEditProfileSubmit);
	...
	private void showImage() {
		if (!firstImageUrl.equals("")) {
			aQuery.id(firstImage).image(firstImageUrl, options)
					.progress(com.example.gyde.desktop.lib.R.id.progressProfile);
		}
		if (!secondImageUrl.equals("")) {
			findViewById(com.example.gyde.desktop.lib.R.id.progressFirst).setVisibility(View.VISIBLE);
			aQuery.id(secondImage).image(secondImageUrl, options);
		}
		if (!thirdImageUrl.equals("")) {
			findViewById(com.example.gyde.desktop.lib.R.id.progressSecond).setVisibility(View.VISIBLE);
			aQuery.id(thirdImage).image(thirdImageUrl, options);
		}
		if (!fourthImageUrl.equals("")) {
			findViewById(com.example.gyde.desktop.lib.R.id.progressThird).setVisibility(View.VISIBLE);
			aQuery.id(fourthImage).image(fourthImageUrl, options);
		}
		if (!fifthImageUrl.equals("")) {
			findViewById(com.example.gyde.desktop.lib.R.id.progressFour).setVisibility(View.VISIBLE);
			aQuery.id(fifthImage).image(fifthImageUrl, options);
		}
		if (!sixthImageUrl.equals("")) {
			findViewById(com.example.gyde.desktop.lib.R.id.progressFive).setVisibility(View.VISIBLE);
	...
	public void onClick(View v) {
		getDataFromPref();
		switch (v.getId()) {
		case com.example.gyde.desktop.lib.R.id.userprofilpicture:
			selectedImage = 1;
			onImageClick(1, firstImageUrl, false);
			break;
		case com.example.gyde.desktop.lib.R.id.firtstImage:
			selectedImage = 2;
			onImageClick(2, secondImageUrl, false);
			break;
		case com.example.gyde.desktop.lib.R.id.secondImage:
			selectedImage = 3;
			onImageClick(3, thirdImageUrl, false);
			break;
		case com.example.gyde.desktop.lib.R.id.thirdimageview:
			selectedImage = 4;
			onImageClick(4, fourthImageUrl, false);
			break;
		case com.example.gyde.desktop.lib.R.id.fourtthimageview:
			selectedImage = 5;
